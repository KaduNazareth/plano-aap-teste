...
import { 
  ...
  User, BookOpen, Download, Loader2, Lightbulb, ImageOff
} from 'lucide-react';
...
const sections: ManualSection[] = [
  {
    ...
    screenshot: '/manual/screenshot-login.png',
  },
  {
    ...
    screenshot: '/manual/screenshot-dashboard.png',
  },
  {
    icon: Calendar,
    ...
    screenshot: '/manual/screenshot-programacao.png',
  },
  {
    icon: FileText,
    ...
    screenshot: '/manual/screenshot-registrar-acao.png',
  },
  {
    icon: ClipboardList,
    ...
    screenshot: '/manual/screenshot-registros.png',
  },
  {
    icon: School,
    ...
    screenshot: '/manual/screenshot-escolas.png',
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    screenshot: '/manual/screenshot-evolucao.png',
  },
  {
    icon: BarChart3,
    title: '10. Relatórios',
    ...
    screenshot: '/manual/screenshot-relatorios.png',
  },
  {
    icon: Printer,
    ...
    screenshot: '/manual/screenshot-lista-presenca.png',
  },
  {
    icon: History,
    ...
    screenshot: '/manual/screenshot-historico-presenca.png',
  },
  {
    icon: UserCog,
    ...
    screenshot: '/manual/screenshot-usuarios.png',
  },
  {
    icon: AlertTriangle,
    title: '14. Pendências',
    ...
    screenshot: '/manual/screenshot-pendencias.png',
  },
  {
    icon: User,
    ...
    screenshot: '/manual/screenshot-perfil.png',
  },
];
...
function ScreenshotImage({ src, alt }: { src: string; alt: string }) {
  ...
  if (failed) {
    return (
      <div
        className="mt-4 flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed"
        style={{
      ...
      >
        <ImageOff className="h-8 w-8" style={{ color: '#9ca3af' }} />
        <span className="text-xs" style={{ color: '#9ca3af' }}>
          Screenshot não disponível — adicione o arquivo em <code style={{ fontSize: '11px', backgroundColor: '#f3f4f6', padding: '2px 4px', borderRadius: '4px' }}>public{src}</code>
        </span>
      </div>
    );
  }
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Screenshot */}
                  {section.screenshot && (
                    <ScreenshotImage src={section.screenshot} alt={`Screenshot - ${section.title}`} />
                  )}

                  {section.tips && section.tips.length > 0 && (
                    <div className="mt-3 rounded-lg p-3" style={{ backgroundColor: '#f0f9ff', borderRadius: '8px', padding: '12px', marginTop: '12px' }}>
